...
#ifdef DEBUG
static NSString * const kMPApplicationBundleIdentifier = @"com.forooghian.macdown-debug";
#else
static NSString * const kMPApplicationBundleIdentifier = @"com.forooghian.macdown";
#endif

static NSString * const kMPApplicationSuiteName = @"com.forooghian.macdown";
